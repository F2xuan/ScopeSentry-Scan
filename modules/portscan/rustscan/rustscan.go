...
func (p *Plugin) Install() error {
	...
	if _, err := os.Stat(RustscanExecPath); os.IsNotExist(err) {
		_, err := utils.Tools.HttpGetDownloadFile(fmt.Sprintf("%v/%v/%v", "https://raw.githubusercontent.com/Autumn-27/ScopeSentry-Scan/refs/heads/1.5-restructure/tools", p.RustDir, p.RustFileName), RustscanExecPath)
		if err != nil {
